=== Gridbox Pro ===
Plugin URL: https://themezee.com/addons/gridbox-pro/
...
Adds additional features and customization options to the Gridbox theme.

== Description ==

The *Gridbox Pro* plugin adds additional features to the Gridbox theme.
...
1. Install the Gridbox Pro Plugin on Plugins -> Add New -> Upload Plugin by uploading the .ZIP plugin file.
...
Please see our [Gridbox Theme Documentation](https://themezee.com/docs/gridbox-documentation/ "Gridbox Theme Documentation").
...
The Gridbox Pro plugin includes the following third-party resources:
