 ...
 */
 ...
 ( function() {
	...
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		scrollButton.setAttribute( 'aria-label', gridboxProScrollToTop.label );
		scrollButton.classList.add( 'scroll-to-top-button' );

		// Add icon to Scroll to Top button.
		var icon = new DOMParser().parseFromString( gridboxProScrollToTop.icon, 'text/html' ).body.firstElementChild;
