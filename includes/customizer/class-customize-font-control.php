...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Gridbox_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			// Set Fonts.
			$this->local_fonts = Gridbox_Pro_Custom_Fonts::get_local_fonts();
			$this->google_fonts = Gridbox_Pro_Custom_Fonts::get_google_fonts();
				...
				<label>
					...
					<div class="customize-font-select-control">
						<select <?php $this->link(); ?>>
							<optgroup label="<?php esc_html_e( 'Local Fonts', 'gridbox-pro' ); ?>">
								<?php
							...
							<optgroup label="<?php esc_html_e( 'Google Web Fonts', 'gridbox-pro' ); ?>">
	  							<?php
