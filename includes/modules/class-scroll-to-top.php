...
class Gridbox_Pro_Scroll_To_Top {
	...
	static function enqueue_script() {
		...
		if ( true === $theme_options['scroll_to_top'] && ! self::is_amp() ) :
			...
			wp_enqueue_script( 'gridbox-pro-scroll-to-top', GRIDBOX_PRO_PLUGIN_URL . 'assets/js/scroll-to-top.min.js', array(), '20220924', true );

			// Passing Parameters to navigation.js.
			wp_localize_script( 'gridbox-pro-scroll-to-top', 'gridboxProScrollToTop', array(
				'icon'  => self::get_svg( 'collapse' ),
				'label' => esc_attr__( 'Scroll to top', 'gridbox-pro' ),
			) );
